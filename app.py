...
def main():
    ...
    # ✅ Fix cursor style for selectboxes & buttons
    st.markdown(
        """
        <style>
        /* Fix cursor for selectboxes */
    ...
    if add_selectbox == "Online":
        ...
        # ✅ Force float inputs
        monthlycharges = float(st.number_input(
            'The amount charged to the customer monthly',
            min_value=0.0, max_value=150.0, value=0.0
        ))
        totalcharges = float(st.number_input(
